    ...
    return (
        <section className='bg-white border rounded mt-3 pt-4'>
            ...
            <div className='px-4 my-4'>
                <p>
                    <Link to=''>Learn more</Link> about writing a great profile
                    or <Link to=''>browse profiles</Link> in your category.
                </p>
                ...
                <div>
                    <label className='w-100'>
                        ...
                        <i className='fas fa-question-circle upw-color ms-3 mb-3'></i>
                        <input
                            type='text'
