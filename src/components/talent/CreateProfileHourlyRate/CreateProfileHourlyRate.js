    ...
    return (
        <section className=' bg-white border rounded mt-3 pt-4'>
            ...
            <div className='p-4 my-3'>
                <p>
                    Clients will see this rate on your profile and in search
                    results once you publish your profile. You can adjust your
                    rate every time you submit a proposal.
                </p>
                <div>
                    ...
                    <div className='mb-3 d-flex justify-content-between border-top pt-3'>
                        <div>
                            <span>
                                ...
                                <a className='upw-color fw-normal ms-3' href=''>
                                    Explain this
                                </a>
                            </span>
                            <p className='w-75'>
                                The Upwork Service Fee is 20% when you begin a
                                contract with a new client. Once you bill over
                                $500 with your client, the fee will be 10%.
                            </p>
                        </div>
                        <div className='me-5 mt-4 d-flex'>
                            <span
                                style={{ position: 'relative', right: '148px' }}
                            >
                                <i className='fas fa-dollar-sign'></i>
                            </span>
