        ...
        <>
            ...
            {proposals.length > 0 ? (
                proposals.map((proposal, index) => {
                    return talent[index] ? (
                        <div
                            className='row border bg-white border-1 ms-0 pt-2'
                            key={index}
                        >
                            ...
                            <div className='col py-3'>
                                <Link
                                    to={{
                                        pathname: `${process.env.PUBLIC_URL}/messages`,
                                        state: talent[index],
                                    }}
                                    className='btn bg-white btn-outline-secondary'
                                    onClick={() =>
                                        sendMSG(talent[index]?.authID)
                                    }
                                >
