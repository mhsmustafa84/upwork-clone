      ...
      <div className="container mt-3">
        <div className="row">
          <div className="col-md-2 mt-5">
              <div className="row"> <NavLink   to="/contactinfo"  style={{textDecoration:"none",color:"black"}} >
                <i className="fas fa-id-card-alt mt-3 me-2"></i>My Info
              </NavLink></div>
        
              <div className="row"><NavLink  to="/billingpayment" style={{textDecoration:"none",color:"black"}} >
                <i className="fas fa-credit-card mt-3 me-2"></i>Billing Methods
              </NavLink></div>
              <div className="row"><NavLink  to="/password" style={{textDecoration:"none",color:"black"}} >
                <i className="fas fa-lock mt-3 me-2"></i>Password & Security
              </NavLink></div>
              <div  className="row"><NavLink to="#"  style={{textDecoration:"none",color:"black"}}>
              ...
              <div  className="row"><NavLink   to="#" style={{textDecoration:"none",color:"black"}} >
                <i className="fas fa-envelope mt-3 me-2"></i>Notification Setting
              </NavLink></div>
              <div  className="row"><NavLink   to="#"  style={{textDecoration:"none",color:"black"}}>
                <i className="fas fa-users mt-3 me-2"></i>Members & Permissions
              </NavLink></div>
              <div  className="row"><NavLink  to="#" style={{textDecoration:"none",color:"black"}} >
