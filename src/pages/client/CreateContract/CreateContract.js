    ...
    const startContract = () => {
            ...
            .then(res => {
                if (res.docs[0].exists) {
                    db.collection('talent')
                        ...
                        .update({
                            status: 'offer',
                            budget: contract.jobBudget || job.jobBudget,
                        });
                }
            });
        ...
        subCollection(
            ...
            'contracts',
            {
                ...
                jobPaymentTypeAr:
                    (contract.jobPaymentType === 'Fixed Price'
                        ? 'عمل بميزانية ثابتة'
                        : 'عمل بالساعة') || job.jobPaymentTypeAr,
            },
        ...
        <div className='container my-5 px-5'>
            ...
            <div className='bg-white py-5'>
                <div className='mx-auto w-50'>
                    <p>
                        Do you want to edit budget or job payment type before
                        you start the contract?
                    </p>
                        ...
                        {edit.paymentType && (
                            ...
                            >
                                <label className='border border-success rounded p-3 text-center w-50'>
                                    ...
                                    <div>
                                        Pay hourly to easily scale up and down.
                                    </div>
                                </label>
                                <label className='border border-success rounded p-3 text-center mx-3 w-50'>
                                    ...
                                    <div>
                                        Define payment before work begins and
                                        pay only when work is delivered.
                                    </div>
                                </label>
                            </div>
                        )}
                    ...
                    {done && (
                        <div
                            className='alert text-upwork d-flex align-items-center justify-content-center'
                            role='alert'
                        >
                            <svg
                                width='30'
                    ...
                    <button
                        className='btn upw-btn d-block mx-auto w-50 mt-4'
