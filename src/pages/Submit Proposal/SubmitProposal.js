                    ...
                    <div className='row'>
                        <div className='col'>
                            <div className='bg-white border rounded-bottom rounded-top'>
                                <h2 className='h4 border-bottom p-4'>
                                    Proposal settings
                                </h2>
                                    ...
                                    {user.connects > 0 ? (
                                        <>
                                            <p>
                                                ...
                                                <strong>2 Connects </strong>
                                                <span className='upw-color'>
                                        ...
                                        <p className='fw-bold text-alert'>
                            ...
                            <div className='bg-white border rounded-bottom rounded-top'>
                                ...
                                <div className='mx-4 mt-3 py-2 pb-4'>
                                    ...
                                    <div className='d-flex mb-3'>
                                        {proposalData?.proposalImages &&
                                            proposalData?.proposalImages.map(
                                                url => {
                                                    return (
                                                        <div
                                                            className='mx-2'
                                    ...
                                    <p className='my-3'>
                                        ...
                                        size of <strong>25MB</strong> each.
                                        Include work samples or other documents
                                        to support your application. Do not
                                        attach your résumé — your Upwork profile
                                        is automatically forwarded to the client
                                        with your proposal.
                                    </p>
                                </div>
                                <div className='border-top ps-4 py-4'>
                                    ...
                                    <button className='btn shadow-none upw-color'>
                                        Cancel
                                    </button>
