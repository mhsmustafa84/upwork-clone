                    ...
                    ? <>
                        <section className=" bg-white border rounded mt-3">
                            <div className="ps-4 d-flex border-bottom justify-content-between align-items-center py-4">
                                ...
                                <Link className="btn upwork-bg-color me-4 px-5" to={`${process.env.PUBLIC_URL}`} onClick={publishJob}>Post Job Now</Link>
                            </div>
                        ...
                        <section className="bg-white border rounded mt-4">
                            <div className="ps-4 my-3 py-2">
                                <Link className="btn upwork-bg-color me-4 px-5" to={`${process.env.PUBLIC_URL}`} onClick={publishJob}>Post Job Now</Link>
                                <Link className="btn border text-success px-5" to={`${process.env.PUBLIC_URL}/home`} onClick={deletePost}>Delete & Exit</Link>
                            </div>
                        </section>
                    </>
                    : <Loader />
