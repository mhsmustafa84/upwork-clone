...
export default function PostJobTitle({ setBtns, btns }) {
  ...
  const addData = () => {
    ...
    console.log(id);
    updateJob({jobCategory: job.jobCategory, jobCategoryAr: job.jobCategory === "Graphic Design" ? "تصميم الجرافيك" : job.jobCategory === "Web Development" ? "تطوير الويب": job.jobCategory ==="Front-End Development"? "تطوير الواجهة الأمامية":job.jobCategory ==="Web Design"? "تصميم الويب":"تطوير الهاتف"}, id);
