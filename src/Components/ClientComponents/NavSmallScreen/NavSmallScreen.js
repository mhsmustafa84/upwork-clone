      ...
      <div className="collapse d-lg-none" id="navbarNavDropdown">
        <ul className="navbar-nav">
          ...
          <li className="nav-item px-3">
            <a className="nav-link mt-2 pt-3 border-top-cn" to={`${process.env.REACT_APP_BASE_ROUTE}/messages`}>
              "Messages"
            </a>
          </li>
          {/* <li className="nav-item px-3">
          ...
          <li className="nav-item px-3">
            <NavLink className="nav-link mt-2 pt-3 border-top-cn" to={`${process.env.REACT_APP_BASE_ROUTE}/notifications`}>
              "Notification"
