...
export default function Header() {
    ...
    return (
        <>
            <header class="nav-bg-cn py-3">

                {/* Header in large screen */}
                <div id="nav-lg-id" class="container d-flex justify-content-center align-items-center">
                    <Logo />
                    <HeaderSearchLg />
                    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent py-0 mx-4">
                        <NavLargScreen />
                    </nav>
                </div>
