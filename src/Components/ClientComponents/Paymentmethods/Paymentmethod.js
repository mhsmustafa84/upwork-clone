              ...
              <div className="tab-pane fade show active" id="visa" role="tabpanel" aria-labelledby="visa-tab">
                <div className="mt-4 mx-4">
                  ...
                  <div className="form mt-3">
                    ...
                    <div className="inputbox"> <input type="text" name="name" min={1} max={999} className="form-control" required="required" /> <span>Card Number</span> <i className="fa fa-eye" /> </div>
