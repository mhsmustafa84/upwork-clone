          ...
          <div className="bg-white py-lg-1 px-4  border  row py-xs-5">
            <div className="col-10 py-3">
              <a href className="advanced-search-link fw-bold">
                I'm looking for video, carousel and image advertising creation
                with branding to make facebook ads
              </a>
              <p className="my-3">
              ...
              <p className="my-3 py-0">
                ...
                Ansar is listening to the customer, I am satisfied with his
                service
              </p>
            </div>
