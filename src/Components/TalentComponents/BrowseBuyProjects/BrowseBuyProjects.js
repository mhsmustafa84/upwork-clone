...
import talentMainSectionBuyProjectDevIT from '../../../images/talent-main-section-buy-project-Dev-IT.png'
import talentMainSectionBuyProjectByDevIT from '../../../images/talent-main-section-buy-project-by-Dev-IT.png'

export default function BrowseBuyProjects() {
    return (
        <div>
            <div className="row mx-lg-5 mx-1 my-md-5 py-md-5 my-3" id="Project-Catalog-section-ID">
                ...
                <div className="row mb-3" id="medium-Project-Catalog-section-ID">
                    <div className="col-12 col-lg-4 fs-md-5 fs-6" id="list-Project-Catalog-ID">
                        <ul className="list-group d-flex flex-lg-wrap flex-lg-column flex-row flex-nowrap overflow-auto mx-1 mb-3">
                            ...
                            <li className="list-group-item border-0 mb-2 col-md-12 col-8">Shopify Development</li>
                            <li className="list-group-item border-0 mb-2 col-md-12 col-8">
                                WordPress Development
        </li>
                            <li className="list-group-item border-0 mb-2 col-md-12 col-8">Data Visualization</li>
                            <li className="list-group-item border-0 mb-2 col-md-12 col-8">Machine Learning</li>
                    ...
                    <div className="col-lg-8 col-12 position-relative">
                        <img className="w-100" src={talentMainSectionBuyProjectDevIT} alt='' />
                        <div className="col-lg-3 col-md-5 col-6 px-3 py-2 position-absolute bottom-0 end-0 bg-white" id="projected-by-ID">
                            <div className="row d-flex justify-content-between">
                                <div className="col-3">
                                    <img className="d-inline-block px-0 rounded-circle border border-2 border-white" id="projected-by-Dev-ID" src={talentMainSectionBuyProjectByDevIT} alt='' style={{ zIndex: 2, left: '-40px' }} />
                                </div>
                                <div className="col-7">
                ...
                <div className="row mx-1" id="lower-Project-Catalog-section-ID">
                    ...
                    <div className="col-lg-8 col-12">
                        <div className="row mb-3 fs-md-5 fs-6" id="Browse-buy-projects-paragraph-ID">
                        ...
                        <div className="row" id="Browse-buy-projects-button-ID">
                            <button className="btn col-lg-2 col-12 mx-lg-0 mx-auto fw-bolder mb-3 btn-success" type="button">
                                Learn more
        </button>
                        </div>
                    </div>
