                ...
                <ul className="navbar-nav">
                    <li className="nav-item hov-cn">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li><Link className="dropdown-item" to="/find-work">Find Work</Link></li>
                    ...
                    <li className="nav-item hov-cn">
                        ...
                        <ul className="dropdown-menu">
                            <div className="nav-dd-cn"></div>
                            <li><Link className="dropdown-item" to="/my-jobs">My Jobs</Link></li>
                            <li><Link className="dropdown-item" to="/all-contract">All Contracts</Link></li>
                    ...
                    <li className="nav-item hov-cn">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li><Link className="dropdown-item" to="/my-reports">My Reports</Link></li>
                            <li><Link className="dropdown-item" to="/life-time-billing">Lifetime Billings by Client</Link></li>
                            <li><Link className="dropdown-item" to="/connects-history">Connects History</Link></li>
                            <li><Link className="dropdown-item" to="/transaction-history">Transaction History</Link></li>
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="#"><i className="far fa-bell fs-5"></i></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="#"><i className="far fa-paper-plane fs-5"
                            style={{ transform: "scaleX(-1)" }}></i></a>
                    </li>
                    <li className="dropdown">
                        ...
                        <ul id="acc-id" className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li className="px-4 py-3">
                                <div id="acc-btns-id" className="btn-group w-100" role="group"
