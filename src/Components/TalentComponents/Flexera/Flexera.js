...
import talentainSectionFlexeraDevIT from '../../../images/talent-main-section-flexera-Dev-IT.png'
import talentMainSectionArticle2FlexeraHeaderDevIT from '../../../images/talent-main-section-article2-flexera-header-Dev-IT.svg'
...
export default function Flexera() {
  ...
  <div className="col-lg-6 col-12 position-relative">
    ...
    <div className="col-6 px-4 py-4 position-absolute bottom-0 end-0 bg-white shadow-sm rounded" id="client-dev-ID">
      <div className="row">
        <div className="col-5">
          <i className="fas fa-rocket display-2 text-secondary" />
        </div>
        <div className="col-7">
          <div className="row fw-bolder fs-3 text-secondary">24x faster</div>
  ...
  <div className="col-lg-6 col-12 pt-md-5">
    ...
    <div className="row my-4 ms-3" id="flexera-sub-header-ID">
      <h4 className="fw-bold">Flexera adapts to changing business needs</h4>
    </div>
    <div className="row fs-6 ms-4 mb-3 text-secondary" id="flexera-paragraph-ID">
